		...
		n)  #!< name of source file
			...
			# c
				...
				#cp $prefix/template.h $PWD/$OPTARG
                                curl -s $prefix/template.h $PWD/$OPTARG
				...
				#cp $prefix/template.c $PWD/$OPTARG
                                curl -s $prefix/template.c $PWD/$OPTARG
